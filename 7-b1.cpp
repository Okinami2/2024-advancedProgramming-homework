...
struct tj_time* tj_time_convert(int input_time)
{
	...
	days = (unsigned int)(input_time / 86400);
	rem = (unsigned int)(input_time % 86400);
	int year;
	for (year = 1970; ; ++year)
	{
		unsigned int leap = ((year % 4 == 0) && (year % 100 != 0)) || (year % 400 == 0);
	...
	// 计算时间
	result.tj_hour = rem / 3600;
	rem %= 3600;
	result.tj_minute = rem / 60;
	result.tj_second = rem % 60;
